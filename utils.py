...
# THEIR USE RANGES FROM DRAWING AND MAKING THE GRID TO A* RELATED NEEDS

# THIS FUNCTION WILL HELP MY gui.py APP KNOW WHAT ELEMENT OF THE SCREEN I CLICKED
...
# THIS FUNCTION IS JUST CALCULATION THE MANHATTAN DISTANCE BETWEEN TWO POINTS
